...
export default function Passenger() {
  const { availFlights, setAvailFlights } = useContext(FlightContext);
  return (
    <div className="my-14 grid grid-cols-4 gap-5 px-72">
      <div className="col-span-1 rounded-lg bg-light ring-1 ring-gray-300"></div>
